...
export class InvoiceController extends Controller {
  ...
  @Get("/")
  @Security("authentication", ["Tenant", "Invoice:List"])
  ...
  @SuccessResponse("200", "OK")
  @Post("/")
  @Security("authentication", ["Tenant", "Invoice:Create"])
  ...
  @SuccessResponse("200", "OK")
  @Get("{id}")
  @Security("authentication", ["Tenant", "Invoice:Get"])
  ...
  @SuccessResponse("200", "OK")
  @Put("{id}")
  @Security("authentication", ["Tenant", "Invoice:Update"])
  ...
  @SuccessResponse("200", "OK")
  @Delete("{id}")
  @Security("authentication", ["Tenant", "Invoice:Delete"])
  ...
  @SuccessResponse("200", "OK")
  @Post("{id}/documents")
  @Security("authentication", ["Invoice:Update", "Tenant"])
