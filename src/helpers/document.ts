...
export const isEmployeeDocumentInvalid = (type: string, documents: Document[] | undefined, company?: Partial<Company>): { document: string, company?: string | null, approved?: boolean } | null => {
